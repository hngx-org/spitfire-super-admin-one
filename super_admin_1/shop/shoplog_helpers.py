...
class ShopLogs:
    ...
    def log_shop_created(self):
        ...
        shop=ShopsLogs(shop_id=self.shop_id,shop_name=self.shop_name,admin_id=self.admin_id,admin_name=self.admin_name,action="created")
        shop.insert()
    ...
    def log_shop_deleted(self,delete_type="temporary"):
        ...
        shop=ShopsLogs(shop_id=self.shop_id,shop_name=self.shop_name,admin_id=self.admin_id,admin_name=self.admin_name,action=f"{delete_type} deleted ")
        shop.insert()
    ...
    def log_shop_reviewed(self):
        ...
        shop=ShopsLogs(shop_id=self.shop_id,shop_name=self.shop_name,admin_id=self.admin_id,admin_name=self.admin_name,action="reviewed")
        shop.insert()
    ...
    def log_shop_restricted(self,restrict_type="temporary"):
        ...
        if restrict_type not in ['no', 'temporary', 'permanent']:
            raise ValueError("invalid restrict type only ('no', 'temporary', 'permanent')")

        shop=ShopsLogs(shop_id=self.shop_id,shop_name=self.shop_name,admin_id=self.admin_id,admin_name=self.admin_name,action=f"{restrict_type} restricted on")
        shop.insert()
    ...
    def log_shop_admin_status(self,status_type="pending"):
        ...
        if status_type not in ['no', 'temporary', 'permanent']:
            raise ValueError("invalid status type only ('pending', 'review', 'approved', 'blacklist')")

        shop=ShopsLogs(shop_id=self.shop_id,shop_name=self.shop_name,admin_id=self.admin_id,admin_name=self.admin_name,action=f"marked {status_type} admin status on")
        shop.insert()
