...
from super_admin_1.models.enum import AdminStatus, Restricted
...
class Shop(BaseModel):
  ...
  def __init__(self, merchand_id, product_id, name, policy_confimation, restricted, admin_status, reviewed, rating):
    """object constructor"""
