...
class Shop(BaseModel):
  ...
  def __repr__(self):
    ...
    return f"(id: {self.id}, merchant_id: {self.merchant_id}, name: {self.name}, policy_confimation: {self.policy_confimation}, restricted: {self.restricted}, admin_status: {self.admin_status}, is_deleted: {self.is_deleted}, reviewed: {self.reviewed}, rating: {self.rating})"
