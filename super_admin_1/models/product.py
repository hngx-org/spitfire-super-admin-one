...
class Product(BaseModel):
  ...
  rating_id = db.Column(db.String(60), db.ForeignKey("user_product_rating.id"))
  ...
  def __init__(self, shop_id, rating_id, category_id, name, description, quantity, price, discount_price, tax, admin_status, is_deleted, is_published, currency):
    """ object constructor"""
    super().__init__()
